...
function Login() {
  ...
  const handleRegister = async () => {
    let res = await axios.post("https://e-commerce-service-qvbq.onrender.com/register", formData)
    // console.log(res)
    if (res.data.success) {
  ...
  const handleLogin = async () => {
    let res = await axios.post("https://e-commerce-service-qvbq.onrender.com/login", formData)
    if (res.data.success) {
      toast.success(res.data.msg)
      setTimeout(() => {
